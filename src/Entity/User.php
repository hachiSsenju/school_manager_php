...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Ecole::class, mappedBy: 'utilisateur', orphanRemoval: true)]
    ...
    public function removeEcole(Ecole $ecole): static
    {
        if ($this->ecole->removeElement($ecole)) {
            ...
            if ($ecole->getUtilisateur() === $this) {
                $ecole->setUtilisateur(null);
            }
        }
